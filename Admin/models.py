...
class Admin(models.Model):
    ...
    reporting_to = models.ForeignKey(CustomUser,on_delete=models.SET_NULL,related_name="reporting_to",null=True,blank=True)
    ...
    registered_by = models.ForeignKey(CustomUser,on_delete=models.SET_NULL,related_name="register_by",null=True,blank=True)
...
class Lead(models.Model):
    ...
    colour_code = models.CharField(max_length=20,choices=COLOUR_CHOICES,blank=True,null=True)
